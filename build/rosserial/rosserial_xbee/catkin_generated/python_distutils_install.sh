...
echo_and_run cd "/home/jetson/Paub/project0/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/jetson/Paub/project0/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/jetson/Paub/project0/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
