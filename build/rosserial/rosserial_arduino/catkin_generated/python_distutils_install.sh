...
echo_and_run cd "/home/jetson/Paub/project0/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/jetson/Paub/project0/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/jetson/Paub/project0/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
